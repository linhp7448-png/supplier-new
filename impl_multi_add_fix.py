...
insert_idx = html.find("function imSmartOpen(name, item) {")
...
multi_add_code = '''
    ...
    function imMultiAddView() {
        ...
        root += '<div class="impanel" style="padding:0;max-height:calc(100vh - 220px);overflow:auto">' +
                '<table class="imtbl" id="multiAddTable" style="width:100%; border-collapse:collapse">' +
...
if insert_idx != -1:
    ...
    with open(r'D:\supplier-new-main\public\index.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("Inserted imMultiAddOpen successfully")
else:
